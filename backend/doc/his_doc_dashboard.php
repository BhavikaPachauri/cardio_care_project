                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title text-center">Cardio Care</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                                            <i class="fab fa-accessible-icon   font-22 avatar-title text-success"></i>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Prescription</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                            ...
                            <a href="his_doc_account.php">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                                                <i class="fas fa-user-tag font-22 avatar-title text-success"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
