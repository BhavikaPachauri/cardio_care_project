                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="his_admin_logout.php">
                                    <span><img src="assets/images/Logo.png" alt="" height="80px" width="130px"></span>
                                </a>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-black-50 fw-bold">Back to <a href="index.php" class="text-black fw-bold  ml-1"><b>Log In</b></a> OR <a href="../../index.php" class="text-black fw-bold ml-1"><b>HomePage</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
